...
import { LiquidMenu } from "refractive-glass-react/controls";
import {
  Check,
  ChevronRight,
  Clock3,
...
export function LiquidGlassDemo({ locale, theme }: { locale: Locale; theme: "light" | "dark" }) {
  ...
  return <LiquidMenu theme={theme} menuLabel={text.menu} openLabel={text.open} trigger={<Ellipsis aria-hidden="true" />}>
